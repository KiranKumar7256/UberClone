...
public class ViewLocationsMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        giveridebtn= findViewById(R.id.giveridebtn);
        giveridebtn.setText("Give ride to "+getIntent().getStringExtra("rUserName"));

        giveridebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             //   Toast.makeText(ViewLocationsMapActivity.this,"onclick",Toast.LENGTH_LONG).show();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pLocation,16.0f));
